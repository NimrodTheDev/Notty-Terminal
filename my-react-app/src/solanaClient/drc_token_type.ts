...
export type NottyTerminal = {
	...
	instructions: [
		{
			...
			accounts: [
				...
				},
				{
					...
					docs: ["CHECK MEtaplex cre4ates this account"];
					writable: true;
					pda: {
						seeds: [
							{
		...
		},
		{
			...
			discriminator: [116, 139, 75, 192, 86, 63, 121, 169];
			accounts: [
				{
					name: "cpSwapProgram";
		...
		{
			name: "purchaseToken";
			discriminator: [119, 226, 211, 96, 33, 236, 251, 96];
			accounts: [
				{
					name: "user";
					writable: true;
	...
	events: [
		{
			name: "purchasedToken";
			discriminator: [56, 73, 120, 14, 17, 77, 119, 203];
		},
		{
			name: "soldToken";
			discriminator: [55, 2, 105, 76, 14, 111, 94, 4];
		},
		{
			name: "tokenCreated";
