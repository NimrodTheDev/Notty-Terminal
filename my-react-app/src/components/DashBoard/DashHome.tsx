...
// add solanabalance here to get theprice of the usd
const DashHome = () => {
    ...
    useEffect(() => {
        const fetchAllCoins = async () => {
            try {
                ...
                const netWorth = holdings.reduce((sum: number, item: { value: number; }) => sum + (item.value || 0)*150, 0);
                        ...
                        >
                            ...
                            <div className="text-right">
                                ...
                                <div className="text-white font-semibold">
                                    ${(coin.value*150).toLocaleString()} ({(coin.value).toFixed(2)} SOL)
                                </div>
                                <div className='flex space-x-1 justify-end items-center'>
                                    <div className="text-white font-semibold">${(coin.market_cap*150).toLocaleString()}</div>
